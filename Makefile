...
hashsum: hashsum.cpp Makefile blake3/blake3_dispatch.c
	...
	g++  -pthread  $(LFLAGS) hashsum.o gosthash2012.o ansi_terminal.o blake3_dispatch.o blake3_portable.o blake3.o blake3_avx2.o blake3_sse41.o blake3_avx512.o -o hashsum
