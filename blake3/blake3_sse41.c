...
INLINE void compress_pre(__m128i *rows, const uint32_t cv[8],
...
INLINE void round_fn(__m128i *v, __m128i *m, size_t r) {
...
INLINE void transpose_vecs(__m128i *vecs) {
...
INLINE void transpose_msg_vecs(const uint8_t *const *inputs,
                               size_t block_offset, __m128i *out) {
